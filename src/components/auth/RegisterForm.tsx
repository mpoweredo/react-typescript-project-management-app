...
import { registerSchema } from 'data/formikValidationSchemas';
							...
							<Form className={classes.form}>
								<div className='flex flex-col gap-1'>
									...
									<Field
										...
										id='name'
										name='name'
										className={`${classes.input} ${touched.name && errors.name && 'outline outline-1 !outline-red-400'}`}
									/>
									<ErrorMessage name='name'>{msg => <p className={classes.error}>{msg}</p>}</ErrorMessage>
								</div>
								<div className='flex flex-col gap-1'>
