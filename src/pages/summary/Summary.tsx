...
const classes = {
	...
	container: 'w-full flex flex-col xl:flex-row gap-10 items-center lg:items-start',
	kanbanChartContainer: 'bg-[#242729] max-w-[500px] h-auto flex w-full min-w-[260px] rounded-lg px-5 py-5 mt-5',
	upcomingEventsContainer: 'bg-[#242729] w-full max-w-[500px] min-w-[260px] rounded-lg px-5 py-5 mt-5',
};
